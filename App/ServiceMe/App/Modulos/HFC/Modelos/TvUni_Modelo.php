<?php
	...
	class TvUni_Modelo extends Modelo {
		
		private $conexion = false;
		
		/**
		 * TvUni_Modelo::__Construct()
		 * 
		...
		/**
		 * TvUni_Modelo::listadoPrioridades()
		 *
		...
		/**  
		 * TvUni_Modelo 	listadoRazonAveria
		...
		/**
		 * TvUni_Modelo::consultaPlantilla()
		 * 
		...
		/**
		 * TvUni_Modelo::guardarNodosExistencia()
		 * 
		...
		/**
		 * TvUni_Modelo::guardarRegionales()
		 * 
		...
		/**
		 * TvUni_Modelo::consultaUbicacion()
		 * 
