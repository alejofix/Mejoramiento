<?php
	...
	class Int_Tel_Modelo extends Modelo {
		
		private $conexion = false;
		
		/**
		 * Int_Tel_Modelo::__Construct()
		 * 
		...
		/**
		 * Int_Tel_Modelo::listadoPrioridades()
		 *
		...
		/**
		 * Int_Tel_Modelo::listadoUbicacion()
		 *
		...
		/**  
		 * Int_Tel_Modelo 	listadoRazonAveria
		...
		/**
		 * Int_Tel_Modelo::consultaPlantilla()
		 * 
		...
		/**
		 * Int_Tel_Modelo::guardarNodosExistencia()
		 * 
		...
		/**
		 * Int_Tel_Modelo::guardarRegionales()
		 * 
		...
		/**
		 * Int_Tel_Modelo::consultaUbicacion()
		 * 
